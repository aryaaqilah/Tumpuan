...
class ReelAnimationPage extends StatefulWidget {
  const ReelAnimationPage({
    super.key,
  });

  @override
  State<ReelAnimationPage> createState() => _ReelAnimationPageState();
}

class _ReelAnimationPageState extends State<ReelAnimationPage>
  ...
  Widget build(BuildContext context) {
    ...
    Timer? timer;
    // Duration timerDuration = Duration(minutes: value.ceil().toInt());
